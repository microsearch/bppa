...
<div id="content" class="wrapper clear">
	...
	<BODY>
		...
		<div id="bottomcontent2">
			<div align="center">
				<TABLE id="Table6" border="0" cellSpacing="0" cellPadding="0" width="750">
					<TR>
						<TD colSpan="2"><h2>The History of the BPPA</h2>
						</TD>
					</TR>
					<TR>
						<TD colSpan="2"><a href="default.asp">Page 1 </a>&nbsp;&nbsp;&nbsp;<a href="history-3.asp">Page 
								3 </a>
					</TR>
					<TR>
						<td><IMG SRC="../images/picket.gif"></td>
						<TD valign="top"><br><br><br><p class="text">In 1969 Boston Police Patrolmen staged one of history's first 
								in-uniform picket lines by a police union. Held in front of Boston's Police 
								Headquarters, this action won the BPPA the respect of Boston's labor community, 
								many of whom made their support for us heard loud and clear in City Hall and 
								Headquarters. Despite some high emotions on both sides, cooler heads prevailed 
								and the issues were resolved to the satisfaction of both the Association and 
								the city.</p>
						</TD>
					</TR>
				</TABLE>

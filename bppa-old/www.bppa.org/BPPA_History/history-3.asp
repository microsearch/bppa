		...
		<div id="bottomcontent2">
			<div align="center">
				<table border="0" width="800" height="100%" cellpadding="0" cellspacing="0" ID="Table5">
					...
					<tr>
						<td colspan="2"><a href=history-2.asp>Page 2</a>&nbsp;&nbsp;&nbsp;<a href=history-4.asp>Page 4</a></td>
					</tr>
					<tr>
						<td colspan="2"><IMG SRC="../images/bush.gif"></td>
					</tr>
					<tr bgcolor="#ffffff">
						<td colspan="2"><br><p class=text> Well into the 1988 race for President, Massachusetts Governor Michael 
								Dukakis held a comfortable lead over Republican George Bush. Then the BPPA, the largest 
								police union in Dukakis' home state, announced they would endorse Bush. Nearly every 
								major newspaper in the country carried this picture on it's front page. Crime became 
								one of the hottest issues in the campaign, and Bush surged in the polls, eventually 
								winning the Presidency.</p></td>
					</tr>
				</table>
			</div>
		</div> </div>
